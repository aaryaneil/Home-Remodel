    ...
    func addProductToCart(productID: String) {
        ...
        ref.setData(data) { (error) in
            if error != nil {
                ...
                self.updateAlert(title: "Success", message: "Product successfully added to cart!")
            }
        }
    }
    ...
    func addProductToWatchList(productID: String){
        ...
        ref.setData(data) { (error) in
            if error != nil {
                ...
                self.updateAlert(title: "Success", message: "The product has been successfully added to your watch list!")
            }
        }
    }
