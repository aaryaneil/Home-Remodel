    ...
    var body: some View {
        VStack {
            HStack(alignment: .center) {
                RatedProductImage(imageURL: product.imageURL)
            ...
            VStack {
                ...
                TextField("Describe this product", text: $textReview.text, axis: .vertical)
            ...
            Button {
                if textReview.text.count < 1 || rating == nil {
                    ...
                    user.alertTitle = "Error"
                    user.alertMessage = "The review must be at least 5 characters long"
                    user.showingAlert = true
                } else {
